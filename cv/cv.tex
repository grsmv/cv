...
\begin{cv}{\spacedallcaps{Sergey Gerasimov}}\vspace{1.5em} % Your name

\noindent\spacedlowsmallcaps{Personal Information}\vspace{0.5em} % Personal information heading

\NewEntry{}{\textit{Born in Ukraine,}}{30 August 1987} % Birthplace and date

\NewEntry{email}{\href{mailto:mail@grsmv.com}{mail@grsmv.com}} % Email address

\NewEntry{website}{\href{http://grsmv.com}{http://grsmv.com}} % Personal website

\NewEntry{phone}{(M) +38 (068) 979 95 35} % Phone number(s)
